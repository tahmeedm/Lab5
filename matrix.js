...
function performOperation(operation) {
    ...
    switch(operation)
    {
        ...
        case 'multiply':
            ...
            break;
        default:
            let errorMessage = "No operations match " + operation;
...
function addMatrices(matrix1, matrix2){ 
    ...
    {
        let errorMessage = "ERROR: Adding two matrices of different dimensions";
        console.log(errorMessage);
        window.alert(errorMessage);
        return result;
    }
...
const subtractMatrices = function (matrix1, matrix2) { 
    ...
    if (matrix1.length != matrix2.length || matrix1[0].length != matrix2[0].length)
    {
        let errorMessage = "ERROR: Subtracting two matrices of different dimensions";
        console.log(errorMessage);
        window.alert(errorMessage);
        return result;
    }
...
const multiplyMatrices = (matrix1, matrix2) => { 
    ...
    {
        let errorMessage = "ERROR: Multiplying two matrices requires the same number of cols in matrix1 as rows in matrix2";
        console.log(errorMessage);
        window.alert(errorMessage);
        return result;
    }
